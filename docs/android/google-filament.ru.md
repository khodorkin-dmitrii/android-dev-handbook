...
Для локального programmable fragment effect внутри UI без 3D scene лучше подходит более компактный и прямой вариант - [AGSL и `RuntimeShader`](agsl-runtime-shader.md).
